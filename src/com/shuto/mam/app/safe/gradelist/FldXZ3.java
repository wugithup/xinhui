...
/**
 * com.shuto.mam.app.safe.gradelist.FldXZ1 华东大区阜阳项目 安健环体系 三级目录字段查找类
 * 
 ...
 * @version V1.0
 */
public class FldXZ3 extends MAXTableDomain {

	public FldXZ3(MboValue mboValue) {
		super(mboValue);
	...
	public MboSetRemote getList() throws MXException, RemoteException {
		...
		String gradelist = thisMbo.getString("GRADELIST2");
