/**  
 * <p> 运行定期取消定期工作（Oplog_CancelYn）字段的fld类
...
/**
 * <p>
 * 运行定期取消定期工作（Oplog_CancelYn）字段的fld类，主要用于控制页面字段只读必填
 * 
 * @author Haox haoxing@shuto.cn
 * @date 2012-11-12下午06:17:49
 * 
 ...
 * @version V1.0
 */
public class FldOplog_CancelYn extends MboValueAdapter {
	/**
	 * <p>
	 ...
	 *            maximo封装好的获得属性值的类
	 */
	public FldOplog_CancelYn(MboValue mbv) {
		super(mbv);
	}
	...
	public void action() throws MXException, RemoteException {
		...
		if (cancel) {
			...
			oppmmbo.setValue("OPLOG_STATUS", "取消", 11l);
