...
/**
 * 高温设备跟踪记录        TZ_GWSBGZ
 com.shuto.mam.app.operation.tz.FldGwsbType 江苏
 * @author       liwc   liwc@shuoto.cn
 * @date         2017年5月17日 上午10:53:38
 * @Copyright:   2017 Shuto版权所有
 * @version      V1.0 
 */
public class FldGwsbType extends MboValueAdapter {
	public FldGwsbType(MboValue mbv) {
		super(mbv);
	}
