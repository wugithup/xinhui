...
public class FldBzlx3 extends MAXTableDomain {
	public FldBzlx3(MboValue paramMboValue) throws MXException {
		super(paramMboValue);
	...
	public MboSetRemote getList() throws MXException, RemoteException {
		...
		String str2 = localMbo.getString("bzlx2");
		setListCriteria("siteid='" + str1
				+ "' and fltype='评级标准分类' and fljb=3 and parentfl='" + str2
				+ "'");
