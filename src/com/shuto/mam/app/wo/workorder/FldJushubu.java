...
public class FldJushubu extends MAXTableDomain {

	public FldJushubu(MboValue mbv) {
		super(mbv);
		// 获得当前字段名
	...
	public MboSetRemote getList() throws MXException, RemoteException {
		...
		this.setListCriteria(" status  = '活动' and locationsite='" + siteid + "' and department ='DEPT02' ");
