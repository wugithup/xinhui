 ...
 * @version V1.0
 */
public class FldPersonjl extends MAXTableDomain {
	public FldPersonjl(MboValue mbv) {
		super(mbv);
	...
	public MboSetRemote getList() throws MXException, RemoteException {
		...
		String sql = " locationorg= '"
				...
				+ "' and  locationsite= '"
				+ siteid
				+ "'   and department is not  null  and   personid not in   ('DEFLT',  'DEFLTREG',  'MAXADMIN', 'SYSADM', 'WORKFLOW', "
