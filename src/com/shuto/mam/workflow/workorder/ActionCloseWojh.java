 ...
 *
 */
public class ActionCloseWojh implements ActionCustomClass  {
	public void applyCustomAction(MboRemote mboremote, Object[] aobj) throws MXException, RemoteException {
		...
		woset.save();
		woset.getMbo(0).setValue("status","已关闭",MboConstants.NOACCESSCHECK);
		...
		woset.getMbo(0).setValue("cancel_reason","关闭领料单",MboConstants.NOACCESSCHECK);
		woset.save(2L);
		woset.close();
