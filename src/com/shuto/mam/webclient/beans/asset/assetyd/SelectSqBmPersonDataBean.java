...
/**
 * com.shuto.mam.webclient.beans.asset.assetyd.SelectSqBmPersonDataBean
 * 设备异动选择会签人员 申请 部门会签人员
 * 
 ...
 * @version V1.0
 */
public class SelectSqBmPersonDataBean extends DataBean {
	...
	public int execute() throws MXException, RemoteException {
		...
		for (int i = 0; i < selectLines.count(); i++) {
			...
			SbydRemote.setValue("type", "申请部门会签", 11L);
