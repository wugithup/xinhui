...
/**
 * com.shuto.mam.webclient.beans.asset.assetyd.SelectJgBmPersonDataBean
 * 设备异动选择会签人员 竣工 部门会签人员
 * 
 ...
 * @version V1.0
 */
public class SelectJgBmPersonDataBean extends DataBean {
	...
	public int execute() throws MXException, RemoteException {
		...
		for (int i = 0; i < selectLines.count(); i++) {
			...
			SbydRemote.setValue("type", "竣工部门会签", 11L);
