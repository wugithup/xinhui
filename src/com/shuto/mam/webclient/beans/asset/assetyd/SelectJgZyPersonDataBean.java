...
/**
 * com.shuto.mam.webclient.beans.asset.assetyd.SelectJgZyPersonDataBean
 * 设备异动选择会签人员 竣工 专业会签人员
 * 
 ...
 * @version V1.0
 */
public class SelectJgZyPersonDataBean extends DataBean {
	...
	public int execute() throws MXException, RemoteException {
		...
		for (int i = 0; i < selectLines.count(); i++) {
			...
			SbydRemote.setValue("type", "竣工专业会签", 11L);
