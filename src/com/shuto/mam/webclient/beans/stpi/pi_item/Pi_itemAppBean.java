package com.shuto.mam.webclient.beans.stpi.pi_item;
...
public class Pi_itemAppBean extends AppBean {

	public Pi_itemAppBean() {
		super();
	}
	...
	public int INSERT() throws MXException, RemoteException {
		...
		MboSetRemote resultSet = getMbo().getMboSet("$resultSet", "ST_PI_ITEM",
				"no = (select max(no) from ST_PI_ITEM where type = '点检'  and siteid = '" + siteid + "')");
