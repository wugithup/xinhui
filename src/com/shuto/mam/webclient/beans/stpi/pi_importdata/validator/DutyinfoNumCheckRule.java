...
public class DutyinfoNumCheckRule implements ExcelRule<String> {
    ...
    private boolean isStandard(String val){
    	String sql = "select ST_PI_DUTYINFONUM from ST_PI_DUTYINFO where  ST_PI_DUTYINFONUM = '"+val+"'";
    ...
    public static void main(String[] args) {
		...
		String daycycle = "00:00:00|08:00:00,08:00:00|16:00:00,16:00:00|00:00:00";
