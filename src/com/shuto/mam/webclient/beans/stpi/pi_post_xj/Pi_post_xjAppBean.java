package com.shuto.mam.webclient.beans.stpi.pi_post_xj;
...
public class Pi_post_xjAppBean extends AppBean {

	public Pi_post_xjAppBean() {
		super();
	}
	...
	public int INSERT() throws MXException, RemoteException {
		...
		MboSetRemote resultSet = getMbo().getMboSet("$resultSet", "ST_PI_POST",
				"no = (select max(no) from ST_PI_POST where type = '巡检'  and siteid = '" + siteid + "')");
