package com.shuto.mam.webclient.beans.oplog.shiguyxbean;
...
/**
 * 事故预想
 com.shuto.mam.webclient.beans.oplog.shiguyxbean.ShiGuYXBean 河北分公司
 * @author       liwc   liwc@shuoto.cn
 * @date         2017年5月5日 下午5:31:25
 * @Copyright:   2017 Shuto版权所有
 * @version      V1.0 
 */
public class ShiGuYXBean extends CAppBean
{
  public boolean hasAuth()
    throws MXException, RemoteException
  {
    long tablesid = getMbo().getLong("ST_SHIGUYXID");
    ...
    MboSetRemote mbosetremote = getMbo().getMboSet("$instance",
      "WFINSTANCE",
      "ownertable='ST_SHIGUYX' and ownerid='" + tablesid + "' and active = 1");
    if (!(mbosetremote.isEmpty())) {
      String s2 = "ownerid='" +
        tablesid +
        "' and ownertable='ST_SHIGUYX' and assignstatus='活动' and assigncode='" +
        s1 + "'";
