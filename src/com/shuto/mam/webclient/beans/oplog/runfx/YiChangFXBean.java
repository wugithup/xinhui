...
/**
 * 异常分析
 com.shuto.mam.webclient.beans.oplog.runfx.YiChangFXBean 河北分公司
 * @author       liwc   liwc@shuoto.cn
 * @date         2017年5月5日 下午8:26:38
 * @Copyright:   2017 Shuto版权所有
 * @version      V1.0 
 */
public class YiChangFXBean extends AppBean
{
    ...
    throws MXException, RemoteException
  {
    ...
    MboSetRemote mbosetremote = getMbo().getMboSet("$instance", 
      "WFINSTANCE", 
      "ownertable='ST_RUNYCFX' and ownerid='" + tablesid + "' and active = 1");
    if (!(mbosetremote.isEmpty())) {
      String s2 = "ownerid='" + 
        tablesid + 
        "' and ownertable='ST_RUNYCFX' and assignstatus='活动' and assigncode='" + 
        s1 + "'";
