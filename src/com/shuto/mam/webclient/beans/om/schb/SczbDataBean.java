...
/**
 *
 * com.shuto.mam.webclient.beans.om.schb.SczbDataBean.java
 * 
 * Email:xiamy@shuto.cn 2017年9月1日 下午5:20:00
 *
 */
public class SczbDataBean extends DataBean {
	public int addrow() throws MXException {
		try {
			super.addrow();
			MboRemote Mbo = getMbo();
			Mbo.setValue("TYPE", "SCZB", 11L);
	...
	public void SEND() throws RemoteException, MXException {
		...
		if (user.equals(createby)) {
			...
			if (er == 2) {
				...
				try {
					String Where = "persongroup='SCHB_SCZB' and RESPPARTYGROUP  in (select personid from person where MOBILEPHONE  is not null)";
