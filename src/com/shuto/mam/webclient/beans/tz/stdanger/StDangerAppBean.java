...
public class StDangerAppBean extends AppBean
{
    ...
    throws MXException, RemoteException
  {
    ...
    localMboRemote.setValue("status", "编制", 2L);
    refreshTable();
    return i;
  }
  ...
  public boolean hasAuth() throws MXException, RemoteException {
    System.out.println();
    long l = getMbo().getLong("TZ_ST_DANGERID");
    ...
    if ("编制".equals(str1))
      return true;
    MboSetRemote localMboSetRemote1 = getMbo().getMboSet("$instance", "WFINSTANCE", "ownertable='TZ_ST_DANGER' and ownerid='" + l + "' and active = 1");

    if (!localMboSetRemote1.isEmpty()) {
      String str3 = "ownerid='" + l + "' and ownertable='TZ_ST_DANGER' and assignstatus='活动' and assigncode='" + str2 + "'";
