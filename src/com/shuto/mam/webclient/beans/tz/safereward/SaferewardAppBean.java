 ...
 * @since:控股台账
 */
public class SaferewardAppBean extends AppBean
{
  public int INSERT()
  ...
  public boolean hasAuth() throws MXException, RemoteException {
    long l = getMbo().getLong("TZ_ST_SAFEREWARDID");
    ...
    if ("编制".equals(str1))
      return true;
    MboSetRemote localMboSetRemote1 = getMbo().getMboSet("$instance", "WFINSTANCE", "ownertable='TZ_ST_SAFEREWARD' and ownerid='" + l + "' and active = 1");

    if (!localMboSetRemote1.isEmpty()) {
      String str3 = "ownerid='" + l + "' and ownertable='TZ_ST_SAFEREWARD' and assignstatus='活动' and assigncode='" + str2 + "'";
