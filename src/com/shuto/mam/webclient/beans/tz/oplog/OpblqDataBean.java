...
* @since  原阜阳项目台账类
* 
* getDataBean("1357435898441");
* 
* 
*/
public class OpblqDataBean extends DataBean
{
  public void tj()
    throws RemoteException, MXException
  {
    DataBean zb = this.app.getDataBean("1357435898441");
    ...
    this.app.getDataBean("1357435898441").reset();
    this.app.getDataBean("1357435898441").save();
