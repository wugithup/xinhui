...
* @since  原阜阳项目台账类
* 	getDataBean("1357367642443");
*/

public class OpjyjcDataBean extends DataBean
{
  public void tj()
    throws RemoteException, MXException
  {
    DataBean zb = this.app.getDataBean("1357367642443");
    ...
    this.app.getDataBean("1357367642443").reset();
    this.app.getDataBean("1357367642443").save();
