package com.shuto.mam.webclient.beans.tz.kgzcgl.wztz;
...
public class LocationAppBean extends AppBean
{
    ...
    throws RemoteException, MXException
  {
    ...
    MboSetRemote localMboSetRemote1 = localMboRemote1.getMboSet("&GDZC", "GDZC", "assetnum='" + paramString1 + "'");
    if (!localMboSetRemote1.isEmpty()) {
      ...
      String str4 = localMboRemote2.getString("GDZCID");
      ...
      localMboRemote3.setValue("GDZCSTATUSNUM", localMboSetRemote2.count() + "", 2L);
      localMboRemote3.setValue("assetnum", paramString1);
      localMboRemote3.setValue("DESCRIPTION", paramString3);
      localMboRemote3.setValue("GDZCID", str4);
