...
/**  
com.shuto.mam.webclient.beans.jsjd.DqjsjddyjdAppBean xx大区 XX项目
* @author       lzq liuzq@shuoto.cn
* @date         2017-4-13 下午4:10:05
* @Copyright:   2017 Shuto版权所有
* @version      V1.0  
*/
public class DqjsjddyjdAppBean extends AppBean
{
  public int INSERT()
    throws MXException, RemoteException
  {
    ...
    MboSetRemote localMboSetRemote1 = localMboRemote1.getMboSet("#JSJDLINE", "JSJDLINE", " ISTEMPLATE='1'  and  type ='电气电压监督' and  siteid='" + str2 + "'   ");

    localMboSetRemote1.setOrderBy("SN desc");
    int j = localMboSetRemote1.count();
    MboSetRemote localMboSetRemote2 = localMboRemote1.getMboSet("JSJDLINE1");
